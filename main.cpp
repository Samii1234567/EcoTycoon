...
int main() {
    ...
    float optX    = (WIN_W - optBtnW) / 2.f;
    sf::FloatRect hotSave  (optX - 140.f, OPTIONS_THEME.saveButtonY,  optBtnW, optBtnH);
    sf::FloatRect hotCancel(optX + 145.f, OPTIONS_THEME.cancelButtonY, optBtnW, optBtnH);

    // --- 3) Inicjalizacja Sliderów ---
    Slider musicSlider(
        (WIN_W - OPTIONS_THEME.sliderWidth) / 2.f - 5.f,
    ...
    while (window.isOpen()) {
        ...
        while (window.pollEvent(e)) {
            ...
            // Przekaż zdarzenie do sliderów, tylko w menu opcji
